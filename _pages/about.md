...
<b>Research Area:</b> The main focus of my research involves developing a version of adelic geometry via topos theory, as well as exploring its interactions with Local-Global problems (both in number theory and homotopy theory). I also have side-projects relating to K-theory (particularly in relation to scissors congruence), tensor-triangulated categories, Manin's Conjecture, and Abstract Elementary Classes.
